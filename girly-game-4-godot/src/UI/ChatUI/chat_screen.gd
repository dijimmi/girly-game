...
var new_convo : Dictionary = {
	Constants.VERONICA_CHAT : [
		...
		Constants.INPUT_TRIGGERED,
		"Can you remind me what Ayumi asked for?",
		Constants.REPLY_TRIGGERED,
		"Oh, sure",
		"But before that, let me tell you how this works.",
		"If you RIGHT CLICK on text, you can copy it to your clipboard",
		"That way you can search by category",
		"Product Info is listed in this order:",
		"product name, description, collection, accesory type and substyle",
		"She said she needed a head piece",
		"From the brand DOLLA FASHION",
